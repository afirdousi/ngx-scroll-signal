...
console.log(__dirname, path.join(rootFolder, '../src/lib'));
...
return Promise.resolve()
  ...
  // Copy package files
  .then(() => Promise.resolve()
    .then(() => _relativeCopy('LICENSE', path.join(rootFolder,'../'), distFolder))
    .then(() => _relativeCopy('package.json', path.join(rootFolder,'../'), distFolder))
    .then(() => _relativeCopy('README.md', path.join(rootFolder,'../'), distFolder))
...
// This naive (but solid) build system is shamelessly copied from https://github.com/filipesilva/angular-quickstart-lib
// as a starting point. This is subject to change in near future.